...
|     2.5   /speckit.analyze
│     2.6 /speckit.implement - Execute implementation 
		  /speckit.git.commit

| 2.7 bun run/astro build (solo comprobar fases criticas) 
ptional commands that you can use for your specs (improve quality & confidence)                                             │
│                                                                                                                               │
